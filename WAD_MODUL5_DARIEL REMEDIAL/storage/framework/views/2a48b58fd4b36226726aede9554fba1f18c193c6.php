...
<body>
   ...
   <nav id="main-navbar" class="navbar navbar-expand-lg navbar-fixed-top navbar-primary bg-primary">
      ...
      <li class="nav-item" style="margin-left:40px;">
        <a class="nav-link text-light" href="Home">My Cars</a>
      </li>
...
<div class="nav navbar-right">
     ...
     <a class="nav-link text-light" href="Dariel_additem.php"> <button type="button" class="btn btn-light "><span>Add Your Car</span></button></a>
      </li> 
  ...
  <div class="container mx-auto my-5">
    ...
    <form action="Dariel_home.php" method="post" enctype="multipart/form-data">
      <div class="row justify-content-center" style="">
        <h3>Tambah Mobil</h3>
        <small>Tambah mobil baru anda ke showroom</small>
          ...
          <div class="card h-100">
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                <h6>Nama Mobil</h6>
                <input required type="text" name="nama_mobil" id="" class="form-control" placeholder="" aria-describedby="helpId">
              </div>

              <div class="form-group">
                <h6 style="margin-top:5px;"> Nama Pemilik</h6>
                <input required type="text" name="nama_pemilik" id="" class="form-control" placeholder="" aria-describedby="helpId" value="Dariel - 1202190255" readonly>
              </div>

               <div class="form-group">
                <h6 style="margin-top:5px;">Merk</h6>
               <input required type="text" name="Merk" id="" class="form-control" placeholder="" aria-describedby="helpId">
              </div>
...
<?php /**PATH C:\xampp\htdocs\WAD_MODUL5_DARIEL\resources\views/showroom/TambahMobil.blade.php ENDPATH**/ ?>