...
<div class="nav navbar-right">
     ...
     <a class="nav-link text-light" href="TambahMobil"> <button type="button" class="btn btn-light "><span>Add Your Car</span></button></a>
      </li> 
...
<li class="nav-item dropdown">
  ...
  <div class="col-md-4" style="margin-top:100px;">
          <div class="card card-home" style="border-radius: 25px;">
             <img class="card-img-top img-poster" src="<?php echo e(URL::asset( $post->image )); ?>" style="padding:25px; border-radius: 40px;">
              ...
              <p class="card-text">
                ...
                <p style="text-align:left;">
                        ...
                        <form action="delete/<?php echo e($post->id); ?>" method="post">
                           <a href="detailmobil/<?php echo e($post->id); ?>">
               <button type="button" class="btn btn-primary " style="width:150px; border-radius:25px;"><span>Lihat Detail</span></button>
              </a>
                                    <button type="submit" style="width:150px; border-radius:25px;" value="<?php echo e($post->id_mobil); ?>" name="deleteAgenda" class="btn btn-danger">Hapus</button>
...
</html><?php /**PATH C:\xampp\htdocs\WAD_MODUL5_DARIEL\resources\views/showroom/Home.blade.php ENDPATH**/ ?>