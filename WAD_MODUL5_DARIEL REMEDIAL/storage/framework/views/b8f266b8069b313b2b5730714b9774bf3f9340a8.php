...
<li class="nav-item dropdown">
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <?php $__currentLoopData = $itemproduk; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div >
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                    <img class="card-img-top img-poster" src="<?php echo e(URL::asset( $post->image )); ?>" alt="Card image cap">
                                    </div>

                                    <div class="col-md-8">
 <div class="form-group">
                <h6>Nama Mobil</h6>
                <input required type="text" name="nama_mobil" id="" class="form-control" placeholder="" aria-describedby="helpId" value="<?php echo e($post->name); ?>" readonly style="background-color:white">
              </div>
              ...
              <div class="form-group">
               ...
               <input required type="text" name="Merk" id="" class="form-control" placeholder="" aria-describedby="helpId" value="<?php echo e($post->brand); ?>" readonly style="background-color:white">
              </div>

              <div class="form-group">
                <h6 style="margin-top:5px;">Tanggal beli</h6>
                 <input required type="date" name="tanggalbeli" id="" class="form-control" placeholder="" aria-describedby="helpId" value="<?php echo e($post->purchase_date); ?>" readonly style="background-color:white">
              </div>

              <div class="form-group">
                <h6 style="margin-top:5px;">Deskripsi</h6>
                 <textarea required class="form-control" name="Deskripsi" id="" rows="3" readonly style="background-color:white"><?php echo e($post->description); ?></textarea>
              </div>
Status Pembayaran : 
                                    </div>
...
</html><?php /**PATH C:\xampp\htdocs\WAD_MODUL5_DARIEL REMEDIAL\resources\views/showroom/detailmobil.blade.php ENDPATH**/ ?>