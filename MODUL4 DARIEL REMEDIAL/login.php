...
<form action="" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control" name="email" id="" value="<?= $savedUsername ?>" aria-describedby="emailHelpId" placeholder="Email">
                        </div>

                        <div class="form-group">
                            <input type="password" class="form-control" name="password" id="" value="<?= $savedPassword ?>" placeholder="Kata Sandi">
