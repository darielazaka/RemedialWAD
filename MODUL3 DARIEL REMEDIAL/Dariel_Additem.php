...
<div class="nav navbar-right">
     ...
     <a class="nav-link text-light" href="Dariel_additem.php"> <button type="button" class="btn btn-light "><span>Add Goods</span></button></a>
      </li>   
    </div>
  </div>
  ...
  <div class="container mx-auto my-5">
    ...
    <form action="Dariel_home.php" method="post" enctype="multipart/form-data">
      <div class="row justify-content-center" style="">
        <h3>Tambah Barang</h3>
        <small>Tambah Barang Ke Warehouse Anda</small>
          ...
          <div class="card h-100">
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <input required type="text" name="nama_pemilik" id="" class="form-control" placeholder="" aria-describedby="helpId" >
              </div>
